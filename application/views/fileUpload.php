...
<link href="<?php echo base_url("assests/font-awesome/css/font-awesome.min.css");?>" rel="stylesheet" type="text/css">
  ...
  <div class="navbar-header">
                ...
                <a class="navbar-brand" style="color: #fff;">E-Attendance Login</a>
            </div>
            </nav>
	<center>
            <div class="login">
			...
			<h1 class="loginheading">Upload Student CSV</h1>
		<?php echo form_open_multipart('admin/csvInsertStudent'); ?>
