...
<link href="<?php echo base_url("assests/font-awesome/css/font-awesome.min.css");?>" rel="stylesheet" type="text/css">
  ...
  <div class="navbar-header">
                ...
                <a class="navbar-brand" style="color: #fff;">E-Attendance Add Lecturer</a>
            </div>
            </nav>
	<center>
            <div class="login">
              <h1 class="loginheading">Add a Lecturer</h1>
                        ...
                        <?php if($this->session->flashdata('message')){echo "<span class='alert-danger'>".$this->session->flashdata('message')."</span>";}?>
                            <span class="loginheading">Add a Lecturer</span>
                
                    <?php echo form_open('admin/lecturerAdd')?>                
                        ...
                        <div class="form-group emailInput has-feedback">
                            ...
                            <button style="margin-bottom: 10px;" type="submit" class="btn btn-default">Submit</button>
                        <?php echo form_close()?>  
